...
<p align="center">보안 개발자를 꿈꾸며 꾸준히 성장하고 있는 개발자입니다. 😭😭💣🤯</p>
...
| **MSG CTF Problem** | Error-based SQL Injection 취약점을 활용한 CTF 문제 출제 | [🔗 GitHub 바로가기](https://github.com/rhkrskdud/MSG_CTF_PROBLEM) |
...
| **MON47 - 악성 URL 분석 솔루션** | URL 문자열, 도메인 메타데이터, HTTP·TLS 정보, HTML·JavaScript 콘텐츠를 단계적으로 분석하는 다계층 악성 URL 탐지 솔루션 | [🌐 서비스 바로가기](https://mon47.com/) |
